      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          {!isRequestTimeAllowed && (
            <div className="mb-8 p-4 bg-yellow-600/20 border border-yellow-600/30 rounded-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 max-w-xl mx-auto">
            <div className="flex flex-col gap-2">
              <Label htmlFor="songName">Canción *</Label>
              <Input
                id="songName"
                name="songName"
            ...
            <div className="flex flex-col gap-2">
              <Label htmlFor="tip">Propina (mínimo $2 USD) *</Label>
              <Input
                id="tip"
                name="tip"
                type="number"
            ...
            <div className="flex items-center gap-2">
              <Checkbox
                ...
                disabled={isSubmitting}
              />
              <Label htmlFor="acceptedTerms">Acepto los <a href="/terms" className="underline text-primary">términos y condiciones</a> *</Label>
            </div>
          ...
          {/* Payment Section */}
          {showPayment ? (
            <div className="mt-8 p-6 bg-gradient-to-br from-muted/40 to-muted/20 rounded-xl border border-primary/30 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  ...
                  className="flex-1 bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-semibold py-4 px-6 rounded-xl shadow-lg"
                ...
                <Button
                  ...
                  className="flex-1 bg-gradient-to-r from-orange-500 to-amber-500 text-white font-semibold py-4 px-6 rounded-xl shadow-lg"
                  disabled={parseFloat(localStorage.getItem('currentTipAmount') || '0') < 2}
                >
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-20 right-10 w-40 h-40 bg-gradient-electric rounded-full blur-3xl" />
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-primary rounded-full blur-3xl" />
      </div>
      {/* Content */}
      <div className="relative z-10 container mx-auto px-4 py-8">
        {/* Header */}
